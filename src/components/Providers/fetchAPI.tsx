  ...
  devtools((set) => ({
    ...
    fetchData: async (username: string) => {
      ...
      try {
        ...
        const [userInfoData, allSubmissionsData, allRating, contestData] = await Promise.all([
        ...
        set({ userInfoData, allSubmissionsData, allRating, contestData, isLoading: false });
      } catch (error) {
